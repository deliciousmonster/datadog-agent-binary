...
/** The datadog.yaml both agents read: every path off the unwritable Datadog defaults, ports pinned either to the ones the component probes or, for dogstatsd/cmd, just to avoid a bind collision with a second component's core agent. */
function renderDatadogYaml(paths, ports) {
	return [
		...
		"# Nothing here polls these two, but left at Datadog's own hardcoded defaults they collide the",
		"# moment a second component on this host starts its own core agent.",
